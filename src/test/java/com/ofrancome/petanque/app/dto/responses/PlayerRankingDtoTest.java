...
class PlayerRankingDtoTest {

    @Test
    @DisplayName("Should correctly convert from Ranking to PLayerRankingDto")
    public void shouldCorrectlyConvertFromRankingToPLayerRankingDto() {
        PlayerRankingDto expected = new PlayerRankingDto(1L, 1216);
        Game game = new Game();
        game.setId(1L);
        ...
        Assertions.assertThat(PlayerRankingDto.from(olivierRanking)).isEqualTo(expected);
    }
