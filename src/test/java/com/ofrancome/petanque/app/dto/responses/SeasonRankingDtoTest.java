...
class SeasonRankingDtoTest {

    @Test
    @DisplayName("Should correctly convert from Ranking to SeasonRankingDto")
    public void shouldCorrectlyConvertFromRankingToSeasonRankingDto() {
        SeasonRankingDto expected = new SeasonRankingDto("olivier", 1216);
        ...
        Assertions.assertThat(SeasonRankingDto.from(olivierRanking)).isEqualTo(expected);
    }
